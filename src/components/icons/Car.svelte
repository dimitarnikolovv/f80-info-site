...
>
    ...
    >
        ...
        <path
            ...
            65 3 165 13 0 40 -69 205 -95 227 -7 6 -48 -27 -123 -99z"
        />
        <path
...
<style lang="scss">
    svg {
        animation: carMove 9s forwards linear;
    ...
    #rear-tire {
        ...
        path {
            transform-origin: 220% 328%;
            animation: tireSpin 2000ms infinite linear;
        }
    }
